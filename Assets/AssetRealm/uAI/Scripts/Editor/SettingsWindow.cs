...
namespace UAI{ 
    public class SettingsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.enabled = GPTClient.Instance.apiKey != _secretKey || GPTClient.Instance.model != GPTClient.models[_selectedModelIndex] || GPTClient.temperature != _temperature || GPTClient.maxTokens != _maxTokens || GPTClient.defaultSavePath != _defaultSavePath || GPTClient.askForSavePath != _askForSavePath;
